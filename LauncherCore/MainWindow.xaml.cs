    ...
    public partial class MainWindow : Window
    {
        ...
        public void CheckForEvent()
        {
            ...
            if (now.Month.Equals(10))
            {
                ...
                image.BeginInit();
                image.UriSource = new Uri("/LauncherCore;component/Resources/LogoHalloweenSpinning.gif",
                    UriKind.Relative);
                image.EndInit();
            ...
            else if (now.Month.Equals(12))
            {
                ...
                BitmapImage image = new BitmapImage();
                image.BeginInit();
                image.UriSource = new Uri("/LauncherCore;component/Resources/LogoChristmasSpinning.gif",
                    UriKind.Relative);
                image.EndInit();
                ImageBehavior.SetAnimatedSource(LogoGif, image);

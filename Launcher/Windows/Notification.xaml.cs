...
namespace Launcher.Windows
{
    ...
    public partial class Notification : Window
    {
        ...
        public Notification(Action callback, Action<bool> yesnoCallback, Buttons buttons, object[] callbackData,
            Action<bool, object[]> yesNoResultCallbackWithData)
        {
        ...
        public static void Show(string message, string title = "Message", Buttons buttons = Buttons.None,
            Action closedCallback = null, Action<bool> yesNoResultCallback = null,
            Action<bool, object[]> yesNoResultCallbackWithData = null, object[] callbackData = null)
        {
            Notification window = new Notification(closedCallback, yesNoResultCallback, buttons, callbackData,
                yesNoResultCallbackWithData);

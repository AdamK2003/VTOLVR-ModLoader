...
namespace LauncherCore.Classes
{
    static class Helper
    {
        ...
        public static List<BaseItem> FindDownloadMods() =>
            CoreCore.Helper.FindMods(Program.Root + Program.ModsFolder);

        public static List<BaseItem> FindMyMods() =>
            CoreCore.Helper.FindMods(Views.Settings.ProjectsFolder + ProjectManager.modsFolder, true);

        public static List<BaseItem> FindDownloadedSkins() =>
            CoreCore.Helper.FindSkins(Program.Root + Program.SkinsFolder);

        public static List<BaseItem> FindMySkins() =>
            CoreCore.Helper.FindSkins(Views.Settings.ProjectsFolder + ProjectManager.skinsFolder);

...
namespace LauncherCore.Classes
{
    public static class ExtensionMethods
    {
        ...
        public static void FilloutForm(this BaseItem baseItem, ref HttpHelper form, bool isMod, string currentPath)
        {
            ...
            form.AttachFile("header_image", baseItem.WebPreviewImage,
                Path.Combine(currentPath, baseItem.WebPreviewImage));
            form.AttachFile("thumbnail", baseItem.PreviewImage,
                Path.Combine(baseItem.Directory.FullName, baseItem.PreviewImage));
